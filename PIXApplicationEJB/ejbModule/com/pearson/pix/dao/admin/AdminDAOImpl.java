...
//	 				stmt.executeUpdate("update PIX_ADMIN_USER set last_login=sysdate where login='"+user.getLogin()+"'");
				...
				//Introduced as part of Fortify SQL Injection Fix
				System.out.println("Inside authenticateUser method 1");
 			  	String tempValue1 = user.getFirstName();
 			  	String validatedValue1 = validateFilePath(tempValue1);
 			  	
 			  	//Introduced as part of Fortify SQL Injection Fix
 			  	System.out.println("Inside authenticateUser method 2");
 			  	String tempValue2 = user.getLastName();
 			  	String validatedValue2 = validateFilePath(tempValue2);
 			  	
 			  	//Introduced as part of Fortify SQL Injection Fix
 			  	System.out.println("Inside authenticateUser method 3");
 			  	String tempValue3 = user.getEmail();
 			  	String validatedValue3 = validateFilePath(tempValue3);
 			  	
 			  	//Introduced as part of Fortify SQL Injection Fix
 			  	System.out.println("Inside authenticateUser method 4");
 			  	String tempValue4 = user.getSsoid();
 			  	String validatedValue4 = validateFilePath(tempValue4);
				
					stmt.executeUpdate("update PIX_ADMIN_USER set last_login=sysdate, FIRST_NAME = '"+validatedValue1+"', LAST_NAME = '"+validatedValue2+"', EMAIL = '"+validatedValue3+"' where SSOID='"+validatedValue4+"'");	// to be un commented
//	 			}
			}
	...
	//Introduced as part of Fortify SQL Injection Fix
	   public static String validateFilePath(String tempFilePath) {
	   ...
	   public static char sanitizeElements(char aChar) {
