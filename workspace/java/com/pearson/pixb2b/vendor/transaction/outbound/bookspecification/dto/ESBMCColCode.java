...
/**
 * ESBMCColCode is a data transfer object to store the Endsheet Binding Material
 * Characteristics ColourCode details of SpecBinding and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class ESBMCColCode implements java.io.Serializable {
	private static final long serialVersionUID = 6192948078056166909L;
