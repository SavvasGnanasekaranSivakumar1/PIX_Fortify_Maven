...
/**
 * PCPMCBasWgt is a data transfer object to store the Specification Press Component
 ...
 */
public class PCPMCBasWgt implements java.io.Serializable {
	private static final long serialVersionUID = -1259813975844786602L;
	...
	private ArrayList pcPMInValList = null;
	/**
	 * Default constructor.
	 */
	public PCPMCBasWgt() {
	...
	/**
	 * @return the pcPMInValList
	 */
	public ArrayList getPcPMInValList() {
		return pcPMInValList;
	}
	/**
	 * @param pcPMInValList the pcPMInValList to set
	 */
	public void setPcPMInValList(ArrayList pcPMInValList) {
		this.pcPMInValList = pcPMInValList;
	}
}
