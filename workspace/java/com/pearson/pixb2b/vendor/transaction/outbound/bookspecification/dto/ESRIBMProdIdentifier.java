 ...
 *
 * Title		: 	ESRIBMProdIdentifier.java
...
/**
 * ESRIBMProdIdentifier is a data transfer object to store the Endsheet Reinforcement Binding Material
 * Characteristics ProductIdentifier details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class ESRIBMProdIdentifier implements java.io.Serializable {
	private static final long serialVersionUID = -881733606747647649L;
