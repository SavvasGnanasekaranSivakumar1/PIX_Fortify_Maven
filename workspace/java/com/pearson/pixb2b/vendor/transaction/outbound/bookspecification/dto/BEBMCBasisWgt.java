...
/**
 * BEBMCBasisWgt is a data transfer object to store the Binding Extras BindingMaterial  
 * Characteristics BasisWeight details of SpecBinding and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class BEBMCBasisWgt implements java.io.Serializable {
	private static final long serialVersionUID = -2083211102243593987L;
	...
	private ArrayList beBMCMInValList 	= null;
	/**
	 * Default constructor.
	 */
	public BEBMCBasisWgt() {
		super();
	}
	/**
	...
	/**
	 * @return the beBMCMInValList
	 */
	public ArrayList getBeBMCMInValList() {
		return beBMCMInValList;
	}
	/**
	 * @param beBMCMInValList the beBMCMInValList to set
	 */
	public void setBeBMCMInValList(ArrayList beBMCMInValList) {
		this.beBMCMInValList = beBMCMInValList;
	}
}
