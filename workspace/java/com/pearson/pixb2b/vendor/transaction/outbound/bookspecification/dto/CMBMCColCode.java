...
/**
 * CMBMCColCode is a data transfer object to store the CaseMaterial BindingMaterial  
 * Characteristics ColourCode details of SpecBinding and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class CMBMCColCode implements java.io.Serializable {
	private static final long serialVersionUID = 1602436944952096331L;
