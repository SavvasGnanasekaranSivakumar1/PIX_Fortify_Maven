...
/**
 * MMCColCode is a data transfer object to store the Mechanical Material  
 * Characteristics ColourCode details of SpecBinding and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class MMCColCode implements java.io.Serializable {
	private static final long serialVersionUID = 2993417302099255967L;
