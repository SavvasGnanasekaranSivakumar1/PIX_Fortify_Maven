...
/**
 * PCPMCBgtness is a data transfer object to store the Specification Press Component
 * Manufacturing Specifications Printing Material Characteristics Brightness 
 * details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class PCPMCBgtness implements java.io.Serializable {
	private static final long serialVersionUID = -9015950056137058321L;
