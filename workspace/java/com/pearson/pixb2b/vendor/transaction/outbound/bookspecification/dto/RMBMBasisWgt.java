...
/**
 * RMBMBasisWgt is a data transfer object to store the Ribbon Binding Material Characteristics
 * BasisWeight details of SpecBinding and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class RMBMBasisWgt implements java.io.Serializable {
	private static final long serialVersionUID = -485421318962017145L;
	...
	private ArrayList rmBMInValList	= null;
	/**
	 * Default constructor.
	 */
	public RMBMBasisWgt() {
	...
	/**
	 * @return the rmBMInValList
	 */
	public ArrayList getRmBMInValList() {
		return rmBMInValList;
	}
	/**
	 * @param rmBMInValList the rmBMInValList to set
	 */
	public void setRmBMInValList(ArrayList rmBMInValList) {
		this.rmBMInValList = rmBMInValList;
	}
}
