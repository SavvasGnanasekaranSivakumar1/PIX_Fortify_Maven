...
/**
 * Caliper is a data transfer object to store the specification Binding   
 * CaseMaking Caliper Details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class Caliper implements java.io.Serializable {
	private static final long serialVersionUID = 5171667338610669268L;
