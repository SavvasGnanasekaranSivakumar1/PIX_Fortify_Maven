...
/**
 * SPProdDesp is a data transfer object to store the Spec Packing
 * ProductDescription details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class SPProdDesp implements java.io.Serializable {
	private static final long serialVersionUID = -1265990920193307600L;
