...
/**
 * PCPMCRecycled is a data transfer object to store the Specification Press Component
 * Manufacturing Specifications Printing Material Recycled details
 * and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class PCPMCRecycled implements java.io.Serializable {
	private static final long serialVersionUID = 2175854135367101628L;
