...
/**
 * DvdMedLeng is a data transfer object to store the Specification NonPress Component 
 * DVD Media Length details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class DvdMedLeng implements java.io.Serializable {
	private static final long serialVersionUID = -6019205784208309319L;
