...
/**
 * SPPCProdIdentifier is a data transfer object to store the Spec Packing Pallet
 * Characteristics ProductIdentifier details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class SPPCProdIdentifier implements java.io.Serializable {
	private static final long serialVersionUID = -2478212097653756990L;
