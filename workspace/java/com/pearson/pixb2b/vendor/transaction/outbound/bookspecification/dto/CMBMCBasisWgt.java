...
/**
 * CMBMCBasisWgt is a data transfer object to store the CaseMaterial BindingMaterial  
 * Characteristics BasisWeight details of SpecBinding and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class CMBMCBasisWgt implements java.io.Serializable {
	private static final long serialVersionUID = -7318940373036922951L;
	...
	private ArrayList cmBMInValList	= null;
	/**
	 * Default constructor.
	 */
	public CMBMCBasisWgt() {
		super();
	}
	/**
	...
	/**
	 * @return the cmBMInValList
	 */
	public ArrayList getCmBMInValList() {
		return cmBMInValList;
	}
	/**
	 * @param cmBMInValList the cmBMInValList to set
	 */
	public void setCmBMInValList(ArrayList cmBMInValList) {
		this.cmBMInValList = cmBMInValList;
	}
}
