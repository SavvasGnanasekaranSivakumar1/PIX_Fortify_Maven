...
/**
 * SPBCBurst is a data transfer object to store the Spec Packing Box
 * Characteristics Burst Details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class SPBCBurst implements java.io.Serializable {
	private static final long serialVersionUID = -8052859664544601339L;
