...
/**
 * SPBCBurstIndex is a data transfer object to store the Spec Packing Box
 * Characteristics BurstIndex Details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class SPBCBurstIndex implements java.io.Serializable {
	private static final long serialVersionUID = 4286233178184577565L;
