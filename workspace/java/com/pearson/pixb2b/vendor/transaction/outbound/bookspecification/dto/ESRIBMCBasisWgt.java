...
/**
 * ESRIBMCBasisWgt is a data transfer object to store the Endsheet Reinforcement Binding
 * Material Characteristics BasisWeight details of SpecBinding and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class ESRIBMCBasisWgt implements java.io.Serializable {
	private static final long serialVersionUID = 3639307349868953331L;
	...
	private ArrayList esRIBMInValList	= null;
	/**
	 * Default constructor.
	 */
	public ESRIBMCBasisWgt() {
		super();
	}
	/**
	...
	/**
	 * @return the esRIBMInValList
	 */
	public ArrayList getEsRIBMInValList() {
		return esRIBMInValList;
	}
	/**
	 * @param esRIBMInValList the esRIBMInValList to set
	 */
	public void setEsRIBMInValList(ArrayList esRIBMInValList) {
		this.esRIBMInValList = esRIBMInValList;
	}
}
