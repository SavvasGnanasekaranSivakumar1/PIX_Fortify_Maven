...
/**
 * SPBCProdDes is a data transfer object to store the Spec Packing Box
 * Characteristics ProductDescription details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class SPBCProdDes implements java.io.Serializable {
	private static final long serialVersionUID = -1373843455058139535L;
