...
/**
 * PCPMCCaliper is a data transfer object to store the Specification Press Component
 * Manufacturing Specifications Printing Material Characteristics Caliper 
 * details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class PCPMCCaliper implements java.io.Serializable {
	private static final long serialVersionUID = -5043385874421970634L;
