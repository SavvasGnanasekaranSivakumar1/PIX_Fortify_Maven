...
/**
 * PCPMCOpacity is a data transfer object to store the Specification Press Component
 * Manufacturing Specifications Printing Material Characteristics Opacity 
 * details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class PCPMCOpacity implements java.io.Serializable {
	private static final long serialVersionUID = -1899055906248128553L;
