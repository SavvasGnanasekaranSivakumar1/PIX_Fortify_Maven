...
/**
 * VCMedLeng is a data transfer object to store the Specification NonPress Component 
 * Video Cassette Media Length details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class VCMedLeng implements java.io.Serializable {
	private static final long serialVersionUID = 1324932908894978031L;
