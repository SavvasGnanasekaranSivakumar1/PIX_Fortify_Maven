...
/**
 * ESBMInVal is a data transfer object to store the Endsheet Binding Material Characteristics  
 * BasisWeight IncrementalValue details of SpecBinding and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class ESBMInVal implements java.io.Serializable {
	private static final long serialVersionUID = -8455473419823257442L;
