 ...
 *
 * Title		: 	SupplierPartyPartyIdentifier.java
...
/**
 * SupplierPartyPartyIdentifier is a data transfer object to store the 
 * Purchase Order details and transfer the same between classes.
 * 
 * @author Abhilasha Nigam
 */
public class SupplierPartyPartyIdentifier implements java.io.Serializable {
   ...
   private String agency = null;
	 ...
	 * Default constructor.
	 */
	public SupplierPartyPartyIdentifier() {
		super();
	}
