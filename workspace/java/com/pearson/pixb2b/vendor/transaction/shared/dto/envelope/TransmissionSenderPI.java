 ...
 *
 * Title		: 	TransmissionSenderPartyIdentifier.java
...
/**
 * TransmissionSenderPartyIdentifier is a data transfer object to store the Transmission Sender 
 * PartyIdentifier Information for Inbound and Outbound transactions.
 * 
 * @author Ashish Agrawal
 */
public class TransmissionSenderPI implements java.io.Serializable {
	private static final long serialVersionUID = 5956070280337367204L;
