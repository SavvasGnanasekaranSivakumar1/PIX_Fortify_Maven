...
/**
 * BuyPartyId is a data transfer object to store the DeliveryMessageBook Header 
 * BuyerParty Party Identifier details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class BuyPartyId implements java.io.Serializable {
	private static final long serialVersionUID = -3178557114486990755L;
