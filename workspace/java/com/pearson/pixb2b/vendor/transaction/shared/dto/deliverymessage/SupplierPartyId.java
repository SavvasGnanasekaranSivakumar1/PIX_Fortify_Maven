...
/**
 * SupplierPartyId is a data transfer object to store the DeliveryMessageBook Header 
 * SupplierParty Party Identifier details and transfer the same between classes.
 * 
 * @author Ashish Agrawal
 */
public class SupplierPartyId implements java.io.Serializable {
	private static final long serialVersionUID = 6496727821568663476L;
