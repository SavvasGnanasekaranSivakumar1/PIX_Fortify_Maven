...
/**
 * LocationPartyContact is a data transfer object to store the 
 * Purchase Order details and transfer the same between classes.
 * 
 * @author Abhilasha Nigam
 */
public class LocationPartyContact implements java.io.Serializable {
	private static final long serialVersionUID = 7523106956352880296L;
