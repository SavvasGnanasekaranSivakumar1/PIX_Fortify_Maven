...
/**
 * LineInfoQtyValue is a data transfer object to store the 
 * Usage details and transfer the same between classes.
 * 
 * @author Abhilasha Nigam
 */
public class ItemLineInfoQtyValue implements java.io.Serializable {	
	private static final long serialVersionUID = -2788405780311746442L;
	private String qtyValue = null;
	private String UOM = null;	
	/**
	 * Default constructor.
	 */
	public ItemLineInfoQtyValue() {
		super();
	}
	/**
	 * @return the qtyValue
