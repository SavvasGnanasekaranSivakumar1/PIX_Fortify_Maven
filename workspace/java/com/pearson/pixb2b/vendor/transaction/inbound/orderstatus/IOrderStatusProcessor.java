 ...
 *
 * Title		: 	IOrderStatusProcessor.java
...
/**
 * IOrderStatusProcessor provide the interface to initiate 
 * the OrderStatus Inbound Transaction processing for different Vendors.
 * 
 * @author Yogesh Tyagi
 */
public interface IOrderStatusProcessor{
	/**
	 * This method process the OrderStatus XML received from vendor
	...
	/**
	 * This method do the Data Validation for OrderStatus XML received from vendor
	 * @param xmlFileNameWithDir
	 * @param validXMLList
	 * @param transName
	 * @param transType
