...
/**
 * LocationPartyPartyIdentifier is a data transfer object to store the 
 * IS details and transfer the same between classes.
 * 
 * @author Abhilasha Nigam
 */
public class LocationPartyPartyIdentifier implements java.io.Serializable {
  
	private static final long serialVersionUID = -1976061887473111271L;
   ...
   private String agency = null;
	 ...
	 * Default constructor.
	 */
	public LocationPartyPartyIdentifier() {
		super();
	}
