 ...
 *
 * Title		: 	InventoryChangeProcessorImpl.java
...
/**
 * InventoryChangeProcessorImpl is an implementation class to process the 
 * the InventoryChange Inbound Transaction XML for different vendors.
 * @author Abhilasha Nigam
 */
public class InventoryChangeProcessorImpl implements IInventoryChangeProcessor{
	/* (non-Javadoc)
	 * @see com.pearson.pixb2b.vendor.transaction.inbound.inventorychange.IInventoryChangeProcessor#processInventoryChange(com.pearson.pixb2b.vendor.transaction.inbound.InboundTransactionFactory, java.lang.String, java.lang.String, java.lang.String, java.lang.String, com.pearson.pixb2b.vendor.transaction.shared.dto.transstatus.TransactionStatusDTO)
	 */
	public String processInventoryChange(InboundTransactionFactory inTransFactory, String xmlFileNameWithDir, String inDirArchiveXmlValid, String inDirArchiveXmlInvalid, String vendorSAN, TransactionStatusDTO transStatusDTO, ArrayList errorList) {
		...
		IInventoryChangeDAO icDAO 	= null;
		String status				= null;
		FileUtils fileUtils			= null;
		
		try {
			B2BLogger.debug("InventoryChangeProcessorImpl.processInventoryChange() method called");
			mapping = new Mapping();
			mapping.loadMapping(IPixB2BConstants.IC_Mapping_XML);
			...
			if(pneDTO != null){
				icDAO = inTransFactory.getInventoryChangeDAO();
				status = icDAO.storeInventoryChangeDetails(pneDTO, transStatusDTO, errorList, inDirArchiveXmlInvalid);
				...
				B2BLogger.info("InventoryChangeProcessorImpl.processInventoryChange() - pneDTO = "+pneDTO);
			}
			B2BLogger.debug("InventoryChangeProcessorImpl.processInventoryChange() method return");
		} catch (IOException e) {
	...
	/* (non-Javadoc)
	 * @see com.pearson.pixb2b.vendor.transaction.inbound.inventorychange.IInventoryChangeProcessor#validateDataAndRegisterError(java.lang.String, java.util.ArrayList, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, com.pearson.pixb2b.vendor.transaction.inbound.InboundTransactionFactory, java.lang.String, java.lang.String)
	 */
	public Boolean validateDataAndRegisterError(String xmlFileNameWithDir, ArrayList validXMLList, String transType, String transName, String transactionSchema, String vendorSAN, String inDirArchiveXmlInvalid, InboundTransactionFactory inTransFactory, String documentNumber, String documentDate) {
		...
		try {
			...
			if(null!= pneDTO && null!=validXMLList && validXMLList.size()>0){
				...
				xmlSupplierSAN = b2bHelper.getPropertyFromEnvelope(pneDTO, IPixB2BConstants.VENDOR_SAN, IPixB2BConstants.transType_INC);
				if(null!=xmlSupplierSAN && !"".equals(xmlSupplierSAN)){
					xmlSupplierSAN = b2bHelper.addDashesInSAN(xmlSupplierSAN);
				}
				xmlDMTransID = b2bHelper.getPropertyFromEnvelope(pneDTO, IPixB2BConstants.XML_TRANS_ID, IPixB2BConstants.transType_INC);
				
				if(null==xmlDMTransID || "".equals(xmlDMTransID.trim())){
					partialErrorDTO = new ErrorDTO();
					partialErrorDTO.setErrorID(IPixB2BConstants.ERROR_ID_119+"");
					...
					String whereClause1 = "pxtm.TRANS_HIST_NO='"+xmlDMTransID+"' and pxtm.process_type='"+IPixB2BConstants.transType_INC+"' and pxtm.pix_trans_id = pxl.TRANS_ID and pxl.SAN='"+xmlSupplierSAN+"' and pxl.PROCESS_TYPE='"+IPixB2BConstants.transType_INC+"'";
					int count1 = b2bHelper.checkForRefIntegrity(tableName1, whereClause1);
					if(count1>0)
					{
						partialErrorDTO = new ErrorDTO();
						partialErrorDTO.setErrorID(IPixB2BConstants.ERROR_ID_120+"");
				...
				if(!dataValidationFlag){
					...
					errorDTOList = b2bHelper.prepareErrorDTOListEx(errorIdList, validXMLList, inDirArchiveXmlInvalid, transactionId, IPixB2BConstants.IC_ISSUE_DATE, documentDate);
	...
	/* (non-Javadoc)
	 * @see com.pearson.pixb2b.vendor.transaction.inbound.inventorychange.IInventoryChangeProcessor#registerError(java.lang.String, java.util.ArrayList, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, com.pearson.pixb2b.vendor.transaction.inbound.InboundTransactionFactory, java.lang.String, java.lang.String, java.util.ArrayList, java.lang.String, com.pearson.pixb2b.vendor.transaction.shared.dto.envelope.PapiNetEnvelopeDTO)
	 */
	public Boolean registerError(String xmlFileNameWithDir, ArrayList validXMLList, String transType, String transName, String transactionSchema, String vendorSAN, String inDirArchiveXmlInvalid, InboundTransactionFactory inTransFactory, String documentNumber, String documentDate,ArrayList errorList, String transactionId, PapiNetEnvelopeDTO pneDTO){
		...
		String ackStatus					= null;			
		IErrorDAO errorDAO 					= null;
		Boolean invChangeErrorFlag			= Boolean.TRUE;
		...
		try {
			if(null!=validXMLList && validXMLList.size()> 0){
				if(errorList != null && errorList.size() > 0){
					...
					errorDTOList = b2bHelper.prepareDAOErrorList(errorList, validXMLList, inDirArchiveXmlInvalid, transactionId, IPixB2BConstants.IC_ISSUE_DATE, documentDate);
					...
					if(null!=errorDTOList && errorDTOList.size()>0){
						invChangeErrorFlag = Boolean.FALSE;
						errorDAO = inTransFactory.geErrorDAO();
