 ...
 *
 * Title		: 	IDeliveryMessageProcessor.java
...
/**
 * IDeliveryMessageProcessor provide the interface to initiate 
 * the DeliveryMessage Inbound Transaction processing for different Vendors.
 * 
 * @author Ashish Agrawal
 */
public interface IDeliveryMessageProcessor{
	/**
	 * This method process the DeliveryMessage XML received from vendor
