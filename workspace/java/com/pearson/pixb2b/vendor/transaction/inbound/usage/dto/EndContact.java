...
/**
 * EndContact is a data transfer object to store the 
 * Usage details and transfer the same between classes.
 * 
 * @author Abhilasha Nigam
 */
public class EndContact implements java.io.Serializable {
	private static final long serialVersionUID = 3677129404574005301L;
