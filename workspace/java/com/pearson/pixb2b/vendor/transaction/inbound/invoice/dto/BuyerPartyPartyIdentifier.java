...
/**
 * BuyerPartyPartyIdentifier is a data transfer object to store the 
 * Purchase Order details and transfer the same between classes.
 * 
 * @author Abhilasha Nigam
 */
public class BuyerPartyPartyIdentifier implements java.io.Serializable {
 	private static final long serialVersionUID = 1221830993493699635L;
	 ...
	 * Default constructor.
	 */
	public BuyerPartyPartyIdentifier() {
		super();
	}
