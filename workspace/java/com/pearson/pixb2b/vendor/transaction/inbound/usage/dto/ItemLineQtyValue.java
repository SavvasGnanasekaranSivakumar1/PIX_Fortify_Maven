...
/**
 * ItemLineQtyValue is a data transfer object to store the 
 * Usage details and transfer the same between classes.
 * 
 * @author Abhilasha Nigam
 */
public class ItemLineQtyValue implements java.io.Serializable {
	private static final long serialVersionUID = -460635051560417716L;
