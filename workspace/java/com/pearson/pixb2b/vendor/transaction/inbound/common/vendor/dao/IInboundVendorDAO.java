...
/**
 * IInboundVendorDAO provide the interface to access 
 * the Outbound / Inbound Vendor details from database.
 * 
 * @author Yogesh Tyagi
 */
public interface IInboundVendorDAO{	
	/**
	 * This method returns Inbound Vendors list.
	 * @param processType
	 * @return ArrayList
	 * @throws SQLException
	 * @throws B2BException
	...
	/**
	 * This method returns Inbound Vendor's FTP server info.
	 * @param processType
	 * @param vendorSAN
	 * @return VendorDTO
	 */
	...
	/**
	 * This method insert into the Feed log wit the start of Inbound cron job.
	 * @return boolean
	 */
	public boolean insertFeedLog();
	
	/**
	 * This method updates the Feed log after the Inbound cron job gets completed.
