...
%>	
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td height="92" colspan="3" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="175" align="right" valign="top"><a href="<%=request.getContextPath()%>/index.html"><img src="<%=request.getContextPath()%>/images/Logo.gif" alt="Pearson Implementation of XBITS" width="177" height="92" border="0" /></a></td>
...
<td width="2"  align="left" valign="top" class="LeftBorder"><img src="<%=request.getContextPath()%>/images/trans.gif" width="2" height="1"></td>
        ...
        <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" valign="bottom" class="bottomtext">copyright pearson 2006</td>
