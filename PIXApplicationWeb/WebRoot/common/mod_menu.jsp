...
<td height="92" colspan="3" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="175" align="right" valign="top"><a href="<%=request.getContextPath()%>/home/home.do"><img src="<%=request.getContextPath()%>/images/Logo.gif" alt="Pearson Implementation of XBITS" width="177" height="92" border="0" /></a></td>
