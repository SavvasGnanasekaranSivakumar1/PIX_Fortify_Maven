...
--%>
    <tr>
         <td><span class="indexTitle"> Welcome to Pearson Implementation of XBITS </span></td>
    </tr>
       ...
       <%--<td width="2" class="DivLeftBroder"><img src="<%=request.getContextPath()%>/images/trans.gif" width="1" height="1"></td>--%>
         <td align="left" valign="top">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                <td class="normalText">XBITS (XML Book Industry Transaction Standards) is a new standard for XML (Extensible Markup Language) transactions to facilitate bi-directional electronic data exchanges between publishers, printers, and component and other media vendors. Pearson Implementation of XBITS ( PIX ) involves B2M and B2B flavors. While B2M is meant for interaction with Vendors that are not yet &quot;B2B enabled&quot;, Pearson's larger goal is to help our Vendors communicate &quot;electronically&quot; in a bi-directional mode with Pearson. This website is Pearson's B2M solution to implement XBITS standard transactions to enable 'paperless' communication from Pearson business units and help Pearson business communication with all our suppliers to be streamlined and in a consistent and standard methodology.<br>
                    </td>
              </tr>
              <tr>
                <td height="22">&nbsp;</td>
              ...
              <tr>
                <td><table width="95%" border="0" cellpadding="0" cellspacing="0" class="table_margin">
                    ...
                    <tr>
                      ...
                      <a href="javascript:MM_openBrowserWindow('/PIXManual/PIXManual.pdf','','scrollbars=yes,width=800,height=500')" class="newslink">PIX Manual</a>
                      </span><br>
                      <span class="newtextContainer"><a href="javascript:MM_openBrowserWindow('/PIXManual/faq.pdf','','scrollbars=yes,width=800,height=500')" class="newslink">Frequently Asked Questions</a>
                      </span><br>
                      <span class="newtextContainer"><a href="javascript:MM_openBrowserWindow('/PIXManual/releasenotes.pdf','','scrollbars=yes,width=800,height=500')" class="newslink">Release Notes</a>
                      </span><br>
